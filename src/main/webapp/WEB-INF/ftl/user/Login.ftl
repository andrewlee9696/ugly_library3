...
<title>Ugly Library--Log In</title>
<style>
.jumbotron{
...
<div class="jumbotron">
<h1><center>Ugly Library Log In</center></h1>
</div>
...
<a href="signup.html" class="btn btn-lg btn-default" role="button">New User? Sign Up Here</a>
</form>
